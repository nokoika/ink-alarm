...
test = hspec $ do
  describe "timeSlotIntersection" $ do
    it "API: [13:00 (金), 15:00(金)), TimeSlot: [12:00, 16:00), 金 のとき、マッチする" $ do
      ...
      FS.timeSlotIntersection (apiStartTime, apiEndTime) utcOffset timeSlot `shouldBe` [(TU.createLocalTime 2021 1 1 13 0, TU.createLocalTime 2021 1 1 15 0)]
    it "API: [23:00 (金), 01:00(土)), TimeSlot: [16:00, 00:00), 金 のとき、マッチする" $ do
      ...
      FS.timeSlotIntersection (apiStartTime, apiEndTime) utcOffset timeSlot `shouldBe` [(TU.createLocalTime 2021 1 1 23 0, TU.createLocalTime 2021 1 2 0 0)]
    it "API: [23:00 (金), 01:00(土)), TimeSlot: [00:00, 01:00), 土 のとき、マッチする" $ do
      ...
      FS.timeSlotIntersection (apiStartTime, apiEndTime) utcOffset timeSlot `shouldBe` [(TU.createLocalTime 2021 1 2 0 0, TU.createLocalTime 2021 1 2 1 0)]
    it "API: [13:00 (金), 15:00(金)), TimeSlot: [12:00, 16:00), 土 のとき、マッチしない" $ do
      ...
      FS.timeSlotIntersection (apiStartTime, apiEndTime) utcOffset timeSlot `shouldBe` []
