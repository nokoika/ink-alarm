...
test = hspec $ do
  ...
  describe "filterDefaultSchedule" $ do
    it "条件全指定 マッチ" $ do
      ...
      F.filterDefaultSchedule query defaultSchedule (TU.createTimeZone 9 "") Q.BankaraChallenge `shouldBe` True
    ...
    it "条件全指定 ステージがマッチしない" $ do
      ...
      F.filterDefaultSchedule query defaultSchedule (TU.createTimeZone 9 "") Q.BankaraChallenge `shouldBe` False
    ...
    it "条件全指定 マッチタイプが違う" $ do
      ...
      F.filterDefaultSchedule query defaultSchedule (TU.createTimeZone 9 "") Q.XMatch `shouldBe` False
  ...
  describe "filterEventMatch" $ do
    it "条件全指定 マッチ" $ do
      ...
      F.filterEventMatch query eventMatch (TU.createTimeZone 9 "") `shouldBe` True
    ...
    it "条件全指定 ステージがマッチしない" $ do
      ...
      F.filterEventMatch query eventMatch (TU.createTimeZone 9 "") `shouldBe` False
  ...
  describe "createICalEventsFromDefaultSchedules" $ do
    it "正常系" $ do
      ...
      let icalEvents = F.createICalEventsFromDefaultSchedules queryRoot defaultSchedules Q.BankaraChallenge
      icalEvents
  ...
  describe "createICalEventsFromEventMatches" $ do
    it "正常系 日本語" $ do
      ...
      let icalEvents = F.createICalEventsFromEventMatches queryRoot eventMatches
      icalEvents
        `shouldBe` [ I.ICalEvent
